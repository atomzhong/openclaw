...
const SIMPLE_API_KEY_PROVIDER_FLOWS: Partial<Record<AuthChoice, SimpleApiKeyProviderFlow>> = {
  ...
  "hunyuan-api-key": {
    ...
    expectedProviders: ["hunyuan"],
    envLabel: "HUNYUAN_API_KEY",
    promptMessage: "Enter Hunyuan API key",
    setCredential: setHunyuanApiKey,
    ...
    noteMessage: [
      "Tencent Hunyuan provides large language models.",
      "Get your API key at: https://cloud.tencent.com/product/hunyuan",
    ].join("\n"),
    noteTitle: "Hunyuan",
  },
  "kilocode-api-key": {
